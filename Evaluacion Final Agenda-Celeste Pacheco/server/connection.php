...
class ConectorBD
{
    ...
    function crearUsuarios(){
        ...
        $correo_usr = 'cpacheco@gmail.com';
        $password_usr_not_hashed = '123456';
        $password_usr = password_hash($password_usr_not_hashed, PASSWORD_DEFAULT);
        $nombre_completo_usr = "Celeste Pacheco Torres";
        $fecha_nacimiento_usr = "1989-02-14";
        $stmt->bind_param("ssss", $correo_usr, $password_usr, $nombre_completo_usr, $fecha_nacimiento_usr);
        $stmt->execute();
        $correo_usr = 'joseluis@gmail.com';
        $password_usr_not_hashed = '145865';
        $password_usr = password_hash($password_usr_not_hashed, PASSWORD_DEFAULT);
        $nombre_completo_usr = "Jose Luis Uyen";
        $fecha_nacimiento_usr = "1983-02-08";
        $stmt->execute();
        $correo_usr = 'carolina@gmail.com';
        $password_usr_not_hashed = 'Usr2k17';
        $password_usr = password_hash($password_usr_not_hashed, PASSWORD_DEFAULT);
        $nombre_completo_usr = "Carolina Vigil Talavera";
        $fecha_nacimiento_usr = "1985-03-27";
        $stmt->execute();
    }
